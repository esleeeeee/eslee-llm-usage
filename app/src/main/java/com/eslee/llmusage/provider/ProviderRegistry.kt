...
class ProviderRegistry(debug: Boolean) {
    ...
    val definitions: List<ProviderDefinition> = buildList {
        ...
        add(consumer("grok", "Grok", "grok.com", "https://grok.com/sign-in", "https://grok.com/?_s=usage", setOf("accounts.x.ai", "auth.grok.com", "auth.grokusercontent.com", "www.grok.com", "x.ai", "www.x.ai")))
